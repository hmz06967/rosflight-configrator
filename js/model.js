...
// generate mixer
var mixerList = [
    {name: 'ESC_CALIBRATION',        pos: 0,  model: 'custom',  image: 'custom'},
    {name: 'Tricopter',        pos: 9,  model: 'tricopter',  image: 'tri'},
    {name: 'Quad +',           pos: 1,  model: 'quad_x',     image: 'quad_p'},
    {name: 'Quad X',           pos: 2,  model: 'quad_x',     image: 'quad_x'},
    //{name: 'Bicopter',         pos: 16, model: 'custom',     image: 'bicopter'},
    //{name: 'Gimbal',           pos: 4,  model: 'custom',     image: 'custom'},
    {name: 'Y6',               pos: 7, model: 'y6',         image: 'y6'},
    {name: 'Hex +',            pos: 3,  model: 'hex_plus',   image: 'hex_p'},
    {name: 'Flying Wing',      pos: 10, model: 'custom',     image: 'flying_wing'},
    //{name: 'Y4',               pos: 19, model: 'y4',         image: 'y4'},
    {name: 'Hex X',            pos: 4,  model: 'hex_x',      image: 'hex_x'},
    {name: 'Octo X8',          pos: 8, model: 'custom',     image: 'octo_x8'},
    {name: 'Octo Flat +',      pos: 5,  model: 'custom',     image: 'octo_flat_p'},
    {name: 'Octo Flat X',      pos: 6,  model: 'custom',     image: 'octo_flat_x'},
    ...
    {name: 'Custom',           pos: 11, model: 'custom',     image: 'custom'},
    {name: 'INVALID MIXER',  pos: 255, model: 'custom',     image: 'custom'},
...
var Model = function (wrapper, canvas) {
    ...
    var model_file = useWebGLRenderer ? mixerList[mixer].model : 'fallback';
